...
#define CLK_EN_GPIOB ((RCC)->APB2EN |= 1 << 3)
#define CLK_EN_GPIOC ((RCC)->APB2EN |= 1 << 4)
#define CLK_EN_GPIOD ((RCC)->APB2EN |= 1 << 5)
#define CLK_EN_GPIOE ((RCC)->APB2EN |= 1 << 6)

#define CLK_EN_AFIO ((RCC)->APB2EN |= 1 << 0)
